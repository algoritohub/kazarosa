                ...
                <div class="w-[100%] float-left inline-block">
                    <div class="w-[100%] bg-[#ffffff] shadow-lg p-[20px] rounded-[20px]">
                        <form action="{{ route('registrar') }}" method="POST">
                            ...
                            <!-- TELEFONE -->
                            <input class="w-[100%] h-[45px] rounded-[8px] border-[1px] pl-[40px] bg-[#fafafa] mb-[10px] outline-none" type="text" id="phone1" name="telefone" placeholder="Telefone"><img src="/img/user.png" class="w-[16px] opacity-[0.5] mt-[-42px] ml-[15px] absolute"/>
                            <!-- NASCIMENTO -->
                        ...
                        <!--  -->
                        <center>
                            <a href="{{ route('login') }}"><p class="text-[13px] mt-[25px] mb-[15px] text-[#a35554]">Já tenho uma conta!</p></a>
                        </center>
                    </div>
                </div>
            </div>
