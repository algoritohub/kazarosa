    ...
    <div class="w-[90%] mx-[5%] mb-[130px] inline-block">
        ...
        <div class="w-[100%] mt-[150px] inline-block">
            ...
            <div class="w-[100%] inline-block">
                <div id="idea" class="w-[60%] pr-[50px] inline-block float-left">
                    ...
                    <div class="w-[100%] p-[30px] overflow-scroll rounded-[20px] border-[1px] border-[#cdcdcd] inline-block">
                        <!--  -->
                        <center>
                            <p class="w-[100%]">00020126500014br.gov.bcb.pix0114393649410001400210Basic Plan5204000053039865406167.005802BR5925KENIA RAISSA PEREIRA PINT6005Natal610959075-81062290525P8XD04138455167036657286763042771</p>
                        </center>
                    </div>
                    <!--  -->
            ...
            <div class="w-[100%] inline-block">
                <div id="idea" class="w-[60%] pr-[50px] inline-block float-left">
                    ...
                    <div class="w-[100%] p-[30px] overflow-scroll rounded-[20px] border-[1px] border-[#cdcdcd] inline-block">
                        <!--  -->
                        <center>
                            <p class="w-[100%]">00020126480014br.gov.bcb.pix0114393649410001400208Vip Plan5204000053039865406257.005802BR5925KENIA RAISSA PEREIRA PINT6005Natal610959075-81062290525MDHG0413845516708701884196304B166</p>
                        </center>
                    </div>
                    <!--  -->
                    <div class="w-[100%] mt-[30px] inline-block">
            ...
            <div class="w-[100%] inline-block">
                <div id="idea" class="w-[60%] pr-[50px] inline-block float-left">
                    ...
                    <div class="w-[100%] p-[30px] overflow-scroll rounded-[20px] border-[1px] border-[#cdcdcd] inline-block">
                        <!--  -->
                        <center>
                            <p class="w-[100%]">00020126520014br.gov.bcb.pix0114393649410001400212Private Plan5204000053039865406360.005802BR5925KENIA RAISSA PEREIRA PINT6005Natal610959075-81062290525SPTG041384551670870263797630462DC</p>
                        </center>
                    </div>
                    <!--  -->
                    <div class="w-[100%] mt-[30px] inline-block">
            ...
            <div id="idea" class="w-[100%] inline-block">
                <div class="w-[60%] pr-[50px] inline-block float-left">80=
                    <!--  -->
                    <p class="mt-[20px] font-bold text-[20px]">Olá {{ $inform['nome'] }}!</p>
                    <p class="mt-[40px] text-[17px]">Bem-vinda ao nosso Clube de Negócios. Parabéns pela escolha! Você está adquirindo o Plano Executive, com benefícios especiais para clientes mensais. Segue os dados de pagamento para confirmar sua compra. Acesse sua conta pelo App Web, <a href="https://www.kazarosa.com/web" target="_blank">https://www.kazarosa.com/web</a>.</p>
                    <p class="my-[20px] text-[11px]">Copie e cole em seu aplicativo de pagamento:</p>
                    <div class="w-[100%] p-[30px] overflow-scroll rounded-[20px] border-[1px] border-[#cdcdcd] inline-block">
                        <!--  -->
                        <center>
                            <p class="w-[100%]">00020126540014br.gov.bcb.pix0114393649410001400214Executive Plan5204000053039865406637.005802BR5925KENIA RAISSA PEREIRA PINT6005Natal610959075-81062290525ZDKX041384551670870337094630444D0</p>
                        </center>
                    </div>
                    <!--  -->
                    <div class="w-[100%] mt-[30px] inline-block">
