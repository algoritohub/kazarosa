            ...
            <header class="md:hidden">
                <div class="w-[100%] h-[30vh] mt-[0px]">
                    <div class="w-[90%] h-[100%] mx-[auto]">
                        ...
                        <!-- AVATAR -->
                        <div id="new_img" class="w-[120px] cursor-pointer h-[120px] rounded-[100px] bg-[#333333]" style="background: url(/img/usuario/{{ $usuario_imagem }}); background-size: 100%;"></div>
                        <!-- NOME -->
                        <p class="font-bold absolute mt-[-75px] ml-[130px] text-[17px]">{{ session('usuario')['nome'] }}</p>
                        <p class="absolute mt-[-53px] ml-[130px] text-[12px]">{{ session('usuario')['cidade'] }}-{{ session('usuario')['estado'] }}</p>
                    </div>
                </div>
                <!-- MODAL -->
                <div class="modal_img">
